...
import 'package:mess_app/widgets_utils.dart/bubble_indication.dart';
...
class _LoginPageState extends State<LoginPage>
                    ...
                    Expanded(
                      ...
                      child: PageView(
                        ...
                        children: <Widget>[
                          ...
                          new ConstrainedBox(
                            constraints: const BoxConstraints.expand(),
                            child: _buildManagementSignIn(context),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildManagementSignIn(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(top: 23.0),
      child: Column(
        children: <Widget>[
