  ...
  Widget build(BuildContext context) {
    return new Semantics(
      ...
      child: new DecoratedBox(
        decoration: new BoxDecoration(              //GRADIENT EFFECT FOR COLUMN SECTION
...
class SectionTitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {                      //TITLE TEXT IN CARDS
  ...
  Widget build(BuildContext context) {
    return new IgnorePointer(
      child: new Container(
        ...
        height: 3.0,
        color: Colors.white.withOpacity(opacity),           //INDICATORS
      ),
    );
  }
}

// Display a single SectionDetail.                                //MENU LIST CUSTOMISATION
class SectionDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // && detail.subtitle == null
      ...
      item = new ListTile(                                        //MENU CONTENTS
